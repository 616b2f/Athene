        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    article_type = table.Column<string>(nullable: false),
                    ...
                    EBook_Title = table.Column<string>(nullable: true),
                    EBook_SubTitle = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EBookArticleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Authors_Articles_EBookArticleId",
                        column: x => x.EBookArticleId,
                        principalTable: "Articles",
                        principalColumn: "ArticleId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Categories_Articles_EBookArticleId",
                        column: x => x.EBookArticleId,
                        principalTable: "Articles",
                        principalColumn: "ArticleId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_AspNetUsers_RentedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authors_EBookArticleId",
                table: "Authors",
                column: "EBookArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_EBookArticleId",
                table: "Categories",
                column: "EBookArticleId");
